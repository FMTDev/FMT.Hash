...
namespace FMT.Hash
{
    public static class Fnv1
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static UInt32 FNV1_String8_Lower(string charArray)
        {
            uint initial_value = 2166136261U;
        ...
        /// </summary>
        /// <returns></returns>
        public static UInt32 FNV1_String8(string charArray)
        {
            uint initial_value = 2166136261U;
            uint FNV_PRIME = 16777619;

            foreach (var c in charArray.Select(x => (byte)x))
                initial_value = (initial_value * FNV_PRIME) ^ c;
